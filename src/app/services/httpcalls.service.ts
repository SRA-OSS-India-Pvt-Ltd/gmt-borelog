...
export class HttpcallsService {
  ...
  // submitboredata(uid: any,orgid: any,proId: any,packageId: any,said: any,
  //   secid: any,
  //   bhno: any,bhlocation: any,
  //   bhlat: any,bhlon: any,
  //   bhchainage: any,chainageid: any,
  //   east: any,north: any,latitu: any,longitu: any,
  //   typeOfcross: any,typeofstru: any,typeofbridge: any,
  ...
  submitboreiterations(bhid: any,itr: any){
      const parameters = {bh_id: bhid,iterations: itr };
        ...
        return this.httpClient.post(`${environment.apiUrl}/submitbore_iterations`, JSON.stringify(parameters));
  ...
  submitLayer2(bhid: any,bhlayer: any,bhno: any,bhlocation: any,
    bhchainage: any,bhchainageId: any,bhlat: any,bhlon: any,
    latitu: any,longitu: any,
    typeOfcross: any,
    ...
    corebarrel: any,boreholepic: any){
    const parameters ={bh_id:bhid,bh_layer:bhlayer,bh_no:bhno,bh_location:bhlocation,
      ...
      latitude: latitu,longitude:longitu,
      ...
      core_barrel:corebarrel,borehole_pic: boreholepic};
    console.log('JSON',JSON.stringify(parameters));
  ...
  submitLayer4(bhid: any,bhlaye: any,depthTermination: any,bhedate: any,
    rvRepName: any,rvRepSign: any,sarepName: any,saRepSign: any,clientRepName: any,
    clientRepSign: any,mdate: any,depthterpic: any, samplepic: any){
    const parameters ={bh_id:bhid,bh_layer:bhlaye,depth_termination:depthTermination,bh_enddate:bhedate,
      rv_rep_name:rvRepName,rv_rep_sign:rvRepSign,sa_rep_name:sarepName,sa_rep_sign:saRepSign,
      client_rep_name:clientRepName,client_rep_sign: clientRepSign,modified_date:mdate,
      depth_termination_pic: depthterpic,sample_pic: samplepic};
    console.log('JSON',JSON.stringify(parameters));
